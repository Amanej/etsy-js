(function() {
  ...
  Listing = (function() {
    ...
    Listing.prototype.createListing = function() {
      var cb, params, _i, _ref;
      params = 2 <= arguments.length ? __slice.call(arguments, 0, _i = arguments.length - 1) : (_i = 0, []), cb = arguments[_i++];
      return (_ref = this.client).post.apply(_ref, ["/listings"].concat(__slice.call(params), [function(err, status, body, headers) {
        if (err) {
          return cb(err);
        }
        if (status !== 201) {
          return cb(new Error('Create listings error'));
        } else {
          return cb(null, body, headers);
        }
      }]));
    ...
    Listing.prototype.updateListing = function() {
      var cb, params, _i, _ref;
      params = 2 <= arguments.length ? __slice.call(arguments, 0, _i = arguments.length - 1) : (_i = 0, []), cb = arguments[_i++];
      return (_ref = this.client).put.apply(_ref, ["/listings/" + this.listingId].concat(__slice.call(params), [function(err, status, body, headers) {
        if (err) {
          return cb(err);
        }
        if (status !== 200) {
